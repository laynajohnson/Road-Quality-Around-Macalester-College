...
Code for the time series visualization to be used in the Shiny app. View the application code to see implementation of function to plug in each dataset and any other final details.
...
This visualization also represents what the map looked like mostly completed. View the shiny app and corresponding code to see final product.
...
This visual shows the daily and weekly highs and lows for our days of recording. Check shiny application code for final details.
...
```{r}
process_accel_data <- function(df) {
...
```{r}
process_and_plot(feb19, "February 19th")
```
